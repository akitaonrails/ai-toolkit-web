...
// plus five smaller ones the owner picked the same day. The owner then swapped Frank Karaoke (to the
// smaller ones) and Frank Manga+ (to the main six) (docs/sources.md, section 10). frank_investigator and
